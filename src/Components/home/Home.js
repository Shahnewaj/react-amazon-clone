        ...
        <div className='home'>
            <div className="home_container">
                ...
                <div className='home_row'>
                    <Product id="1" title='the orgin - dan brown . A novel about that is unknown to me and i never read dan brown novel ' price={20} image='https://m.media-amazon.com/images/I/51GDJjCUN1L.jpg' 
                    rating={5}
                    />             
                    <Product id="2" title='the orgin - dan brown . A novel about that is unknown to me and i never read dan brown novel ' price={19.19} image='https://m.media-amazon.com/images/I/51GDJjCUN1L.jpg' 
                    rating={5}
                    />             
                    
                </div>
                <div className='home_row'>
                <Product id="3" title='the orgin - dan brown . A novel about that is unknown to me and i never read dan brown novel ' price={19.30} image='https://m.media-amazon.com/images/I/51GDJjCUN1L.jpg' 
                    rating={5}
                    />     
